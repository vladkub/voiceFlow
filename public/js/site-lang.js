...
(function () {
  ...
  const RU = {
    ...
    'index.desk.modal.mac_easy_meta': 'Скопировать команду для Терминала',
    'index.desk.modal.hint': 'После установки войдите в аккаунт — приложение подключится к серверу TalkPilot.',
    'index.desk.modal.mac_tip': 'macOS: нажмите «простая установка» — команда скопируется. Откройте Терминал (⌘+Пробел → Terminal), вставьте ⌘+V и Enter. Не открывайте скачанный .command двойным кликом — macOS его блокирует.',
  ...
  const EN = {
    ...
    'index.desk.modal.mac_easy_meta': 'Copy Terminal command',
    'index.desk.modal.hint': 'After installation, sign in — the app will connect to the TalkPilot server.',
    'index.desk.modal.mac_tip': 'macOS: tap “easy install” to copy the command. Open Terminal (⌘+Space → Terminal), paste ⌘+V and press Enter. Do not double-click a downloaded .command — macOS blocks it.',
