...
(function () {
  ...
  const RU = {
    ...
    'index.desk.modal.mac_easy_meta': 'Рекомендуется · двойной клик',
    'index.desk.modal.hint': 'После установки войдите в аккаунт — приложение подключится к серверу TalkPilot.',
    'index.desk.modal.mac_tip': 'macOS: выберите «простая установка», скачайте файл и дважды нажмите его. Если macOS спросит — правый клик → «Открыть». Не перетаскивайте .app вручную.',
  ...
  const EN = {
    ...
    'index.desk.modal.mac_easy_meta': 'Recommended · double-click',
    'index.desk.modal.hint': 'After installation, sign in — the app will connect to the TalkPilot server.',
    'index.desk.modal.mac_tip': 'macOS: choose “easy install”, download the file and double-click it. If macOS asks — right-click → Open. Do not drag the .app manually.',
