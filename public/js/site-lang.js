...
(function () {
  ...
  const RU = {
    ...
    'index.desk.modal.mac_meta': 'DMG · затем «Install TalkPilot»',
    'index.desk.modal.mac_easy': 'macOS · простая установка',
    'index.desk.modal.mac_easy_meta': 'Один файл · двойной клик',
    'index.desk.modal.hint': 'После установки войдите в аккаунт — приложение подключится к серверу TalkPilot.',
    'index.desk.modal.mac_tip': 'macOS: скачайте «простую установку» и дважды нажмите файл (если macOS спросит — правый клик → «Открыть»). Либо откройте DMG и запустите «Install TalkPilot».',
  ...
  const EN = {
    ...
    'index.desk.modal.mac': 'macOS',
    'index.desk.modal.mac_meta': 'DMG · then run “Install TalkPilot”',
    'index.desk.modal.mac_easy': 'macOS · easy install',
    'index.desk.modal.mac_easy_meta': 'One file · double-click',
    'index.desk.modal.hint': 'After installation, sign in — the app will connect to the TalkPilot server.',
    'index.desk.modal.mac_tip': 'macOS: download “easy install” and double-click it (if macOS asks — right-click → Open). Or open the DMG and run “Install TalkPilot”.',
